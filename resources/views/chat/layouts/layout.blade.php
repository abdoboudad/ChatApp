...
<head>
    ...
    https://themes.mintycodes.com/quicky/assets/media/avatar/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="
    https://themes.mintycodes.com/quicky/assets/media/avatar/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="
    https://themes.mintycodes.com/quicky/assets/media/avatar/favicon-16x16.png">
    <link rel="shortcut icon" href="
    https://themes.mintycodes.com/quicky/assets/media/avatar/favicon.ico">
...
<style type="text/css">img[onload^="SVGInject("]{visibility:hidden;};</style><link rel="stylesheet" href="https://cdn.jsdelivr.net/emojione/assets/3.1/sprites/emojione-sprite-32.css"></head>
<style>
    #chatContactTab > li{
        height: 90px;
    }
...
<body class="chats-tab-open" data-new-gr-c-s-check-loaded="14.1112.0" data-gr-ext-installed="" data-new-gr-c-s-loaded="14.1112.0">
    ...
    <div class="main-layout">
                                        ...
                                        <li class="nav-item list-inline-item mr-0">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="#" role="button" data-toggle="modal" data-target="#startConversation">New
                                                        Chat</a>
                                                    <a class="dropdown-item" href="#" role="button" data-toggle="modal" data-target="#createGroup">Create
                                                        Group</a>
                                                    <a class="dropdown-item" href="#" role="button" data-toggle="modal" data-target="#inviteOthers">Invite
                                                        Others</a>
                                                </div>
                                            </div>
                                        </li>
        ...
        <!-- App Add-ons Start -->
        <div class="appbar appbar-hidden">
    ...
    <!-- Javascript Files -->
    <script src="https://themes.mintycodes.com/quicky/assets/vendors/jquery/jquery-3.5.0.min.js"></script>
    <script src="https://themes.mintycodes.com/quicky/assets/vendors/bootstrap/bootstrap.bundle.min.js"></script>
    <script src="https://themes.mintycodes.com/quicky/assets/vendors/magnific-popup/jquery.magnific-popup.min.js"></script>
    <script src="https://themes.mintycodes.com/quicky/assets/vendors/svg-inject/svg-inject.min.js"></script>
    <script src="https://themes.mintycodes.com/quicky/assets/vendors/modal-stepes/modal-steps.min.js"></script>
    <script src="https://themes.mintycodes.com/quicky/assets/vendors/emojione/emojionearea.min.js"></script>
    <script src="https://themes.mintycodes.com/quicky/assets/js/app.js"></script>
...
<div id="torrent-scanner-popup" style="display: none;"></div><ul class="dropdown-menu textcomplete-dropdown" id="textcomplete-dropdown-1" style="display: none; left: 0px; position: absolute; z-index: 100;"></ul></body>